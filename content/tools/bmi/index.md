...
- **표준체중**은 BMI 22에 해당하는 몸무게예요. 통계적으로 질병 위험이 가장 낮다고 알려진 값이라 '목표 체중'으로 자주 써요.
- **적정체중 범위**는 BMI 18.5~23 사이에 드는 구간이에요. 이 안에만 있으면 정상이라, 굳이 표준체중 한 점에 딱 맞출 필요는 없어요.

예를 들어 키 170cm라면 표준체중은 약 63.6kg, 적정 범위는 약 53.5~66.5kg이에요. 위 계산기에서 내 키에 맞는 정확한 범위를 바로 확인할 수 있어요.

## BMI는 정상인데 뱃살이 걱정된다면

BMI는 '전체 체중'만 보기 때문에 지방이 어디에 붙었는지는 알려주지 못해요. 그래서 **허리둘레**를 함께 보는 게 좋아요.

- 복부비만 기준(대한비만학회): **남성 90cm 이상, 여성 85cm 이상**
- BMI가 정상이어도 허리둘레가 기준을 넘으면 내장지방이 많은 '마른 비만'일 수 있어요.

## 자주 묻는 질문

**Q. 어린이·청소년도 이 기준으로 보나요?**
아니에요. 만 18세 미만은 성장 단계라 나이·성별별 'BMI 백분위수'를 따로 써요. 이 계산기는 성인 기준이에요.

**Q. 임신 중에도 참고할 수 있나요?**
임신 중에는 BMI가 체중 관리 지표로 적절하지 않아요. 산부인과에서 안내하는 권장 체중 증가 범위를 따르세요.

**Q. 운동을 하는데 과체중으로 나와요.**
근육은 지방보다 무거워서, 근육량이 많으면 BMI가 높게 나올 수 있어요. 이럴 땐 체지방률·인바디를 함께 보는 게 정확해요.

**Q. 살을 빼려면 하루 몇 칼로리를 줄여야 하나요?**
목표 체중과 활동량에 따라 달라요. [칼로리·기초대사량 계산기](/tools/calorie/)로 내 유지·감량 칼로리를 먼저 확인해 보세요.
