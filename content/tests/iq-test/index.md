...
var QS=[
 ["다음 수열의 빈칸은?  2, 4, 8, 16, ?",["24","30","32","36"],2,"num"],
 ["알파벳 규칙의 다음은?  A C E G ?",["H","I","J","K"],1,"pat"],
 ["'교사 : 학교'의 관계와 같은 것은?  '판사 : ?'",["법원","경찰서","죄인","변호사"],0,"ver"],
 ["모든 포유류는 척추동물이다. 고래는 포유류다. 따라서 고래는?",["무척추동물이다","척추동물이다","어류다","알 수 없다"],1,"log"],
 ["다음 수열의 빈칸은?  1, 2, 6, 24, 120, ?",["240","360","600","720"],3,"num"],
 ["마주보는 면의 합이 7인 표준 주사위. 2의 반대편 면은?",["3","4","5","6"],2,"spa"],
 ["규칙을 찾아 빈칸을 채워요.  100, 96, 88, 72, ?",["40","48","56","64"],0,"pat"],
 ["'응축 ↔ 팽창'과 같은 관계인 짝은?",["수축-확장","성장-성숙","관찰-응시","상승-비상"],0,"ver"],
 ["다음 수열의 빈칸은?  2, 5, 10, 17, 26, ?",["34","36","37","40"],2,"num"],
 ["어떤 학생은 안경을 쓴다. 안경 쓴 사람은 모두 책을 읽는다. 반드시 참인 것은?",["모든 학생은 책을 읽는다","어떤 학생은 책을 읽는다","책 읽는 사람은 모두 학생이다","학생은 안경을 안 쓴다"],1,"log"],
 ["27개로 만든 3×3×3 정육면체 겉면을 칠했다. 세 면이 칠해진 블록은 몇 개?",["4","6","8","12"],2,"spa"],
 ["다음 수열의 빈칸은?  1, 3, 7, 15, 31, ?",["47","55","63","127"],2,"num"],
 ["다음 중 분류 관계가 나머지와 다른 하나는?",["박쥐 : 포유류","펭귄 : 조류","고래 : 어류","악어 : 파충류"],2,"ver"],
 ["다음 수열의 빈칸은?  2, 6, 12, 20, 30, ?",["36","40","42","44"],2,"pat"],
 ["세 명 중 한 명만 거짓말을 한다. 갑:'나는 거짓말을 안 한다' 을:'갑은 거짓말쟁이다' 병:'을은 거짓말쟁이다'. 거짓말쟁이는?",["갑","을","병","알 수 없다"],1,"log"],
 ["다음 수열의 빈칸은?  4, 9, 25, 49, 121, ?",["144","169","143","168"],1,"num"],
 ["4×4×4(64개) 정육면체 겉면을 칠했다. 한 면도 칠해지지 않은 안쪽 블록은?",["4","8","12","16"],1,"spa"],
 ["'물 : 갈증'의 관계처럼, '지식 : ?'",["학교","무지","책","지혜"],1,"ver"],
 ["P이면 Q이다. Q가 아니다. 그리고 R이면 P이다. 반드시 참인 것은?",["P이다","Q이다","R이다","R이 아니다"],3,"log"],
 ["읽어주기 수열의 다음은?  1, 11, 21, 1211, 111221, ?",["131221","312211","112221","122112"],1,"pat"]
];
var idx=0;
