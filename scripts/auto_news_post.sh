...
그 다음 본문 작성 규칙:
- 뉴스 데이터에서 그날 가장 주요하고 영향력 있는 기사를 우선 선별할 것. 사소한 기사보다 많은 사람들이 관심을 가질 만한 핵심 뉴스 중심으로.
...
- 정치: 반드시 대한민국(한국) 국내 정치만 포함. 미국/일본/유럽 등 해외 정치 기사는 절대 넣지 말 것. 반드시 1~2건 포함
- 경제: 국내 + 글로벌 경제 모두 포함. 반드시 2~3건 포함
- 사회: 반드시 대한민국(한국) 국내 사회 뉴스만 포함. 해외 사회 기사는 절대 넣지 말 것. 반드시 1~2건 포함
- 사건사고: 반드시 대한민국(한국) 국내에서 발생한 사건사고만 포함. 해외 사건사고는 절대 넣지 말 것. 반드시 1~2건 포함
- 정치/사회/사건사고에 한국 국내 기사가 없으면 해외 기사를 넣지 말고 "오늘은 주요 국내 뉴스가 없습니다"로 표시
